...
// embedded hal traits
use embedded_hal::digital::v2::{OutputPin, InputPin};   // unproven feature needed
...
pub const FPGA_SPI_FREQUENCY: u32 = 16_000_000;
pub const FPGA_SPI_MODE: Mode = spi::Mode{
    polarity: spi::Polarity::IdleLow,
    phase: spi::Phase::CaptureOnFirstTransition,
};

pub struct FPGA<SPI, InitP, PROG, DoneP> {
    spi: SPI,
    init_b: Input<InitP>,
...
*/
impl<SPI, InitP, PROG, DoneP, SpiE, PinE> FPGA<SPI, InitP, PROG, DoneP>
    where 
        ...
        PROG: OutputPin<Error = PinE>,
{
    ...
    pub fn new(spi: SPI, init_b: Input<InitP>, prog_b: PROG, done: Input<DoneP>) 
    ...
    pub fn set_duty_cycles(&mut self, duty_cycles: &mut [DutyCycle; 5]) 
        -> Result<[u8;2], FpgaError<SpiE, PinE>> 
        {
        ...
        // this is for the dribbler :)
        write_buffer[10] = 0x40;
        ...
        // return status code
        Ok( [write_buffer[0], write_buffer[4]] )
    }
